...
relationships = ['vater', 'mutter', 'sohn', 'tochter', 'bruder', 'schwester', 'enkel', 'enkelin', 'nichte',
            'neffe', 'onkel', 'tante']
entities = ['ich', 'meine', 'mein', 'meinen', 'meines', 'lisa', 'max', 'hans', 'hubert',
            'lukas', 'london', 'herbert']
...
def iterate(exclude_elem, head):
    ...
    else:  # if no direct relationship between names was found
