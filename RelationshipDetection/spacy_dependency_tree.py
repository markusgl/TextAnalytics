...
doc = nlp(u'''Subsequent members of the Hohenzollern family ruled until 1918 in Berlin, first as electors of Brandenburg.''')

neo4j_graph = Neo4jGraph()


def add_to_neo4j(node1, node2, node1_type, node2_type, rel_type='KNOWS'):
...
def iterate(text):
    for token in text:
        ...
        add_to_neo4j(node1, node2, node1_type, node2_type, relationship_type)
        #add_to_neo4j(node2, node1, node2_type, node1_type)
